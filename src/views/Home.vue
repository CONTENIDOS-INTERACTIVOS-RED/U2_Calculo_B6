        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad de cálculo aborda los conceptos fundamentales de límites y continuidad, esenciales para comprender el comportamiento de las funciones. Se estudian la definición formal de límite, sus propiedades y métodos de cálculo, así como los teoremas clave sobre continuidad. Se incluyen aplicaciones en áreas como física, economía y biología. Además, se exploran los límites laterales, bilaterales, infinitos y las asíntotas. La unidad también introduce propiedades algebraicas y métodos para evaluar límites, incluyendo la resolución de indeterminaciones. Finalmente, se presentan ejercicios prácticos y recursos de apoyo para fortalecer el aprendizaje.
